    ...
    <div className="bg-white py-3 shadow-2xl px-4 md:px-0">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div className="flex gap-7 items-center">
          <Link to={"/"}>
            <h1 className="font-bold text-3xl text-gray-700">
              <span className="text-red-500 font-serif">Z</span>ink
            </h1>
          </Link>
        ...
        <nav className="flex gap-7 items-center">
          <ul className="md:flex gap-7 items-center text-gray-700 text-xl font-semibold hidden">
            <NavLink
              to="/"
              className={({ isActive }) =>
                `${
          ...
          <Link to={"/cart"} className="relative">
            ...
            <span className="bg-red-500 px-2 rounded-full absolute -top-3 -right-3 text-xs text-white">
              {cartItem.length}
            </span>
          </Link>
